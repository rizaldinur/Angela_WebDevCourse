...
app.post("/submit", (req, res) => {
  ...
  const randAdjIndex = Math.floor(Math.random() * adj.length);
  const randNounIndex = Math.floor(Math.random() * noun.length);
  const randomName = `${adj[randAdjIndex]} ${noun[randNounIndex]}`;
  res.locals.randomname = randomName;
